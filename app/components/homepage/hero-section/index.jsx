        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="flex items-center gap-3">
            <Link href="#contact" className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
              <button className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            ...
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                height={60}
                alt="profile"
                className="rounded-full border-2 border-pink-500 shadow-[0_0_15px_#d946ef]"
              />
              <div>
                <p className="text-pink-400 font-bold">{personalData.name}</p>
                <p className="text-gray-400 text-xs">{personalData.designation}</p>
              </div>
            </div>
            ...
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-amber-300">'Antonio Lo Sapio'</span>
                <span className="text-gray-400">,</span>
              </div>
              ...
              <div>
                ...
                <span className="text-gray-400">[</span>
                <span className="text-amber-300">'Java','SpringBoot','Angular','Flutter','Kotlin','MySql','MongoDB',
                  'Postgres','Docker'</span>
                <span className="text-gray-400">],</span>
              </div>
              ...
              <div>
                <span className="ml-8 mr-2 text-white">problemSolver:</span>
                <span className="text-orange-400">true</span><span className="text-gray-400">,</span>
              </div>

              <div>
                <span className="ml-8 mr-2 text-green-400">hireable:</span>
                <span className="text-orange-400">function</span>
                <span className="text-gray-400">{'() {'}</span>
              </div>

              <div>
                <span className="ml-16 mr-2 text-orange-400">return</span>
